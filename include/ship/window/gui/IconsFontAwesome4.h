 ...
 *
 * Auto-generated header mapping Font Awesome 4.x icon names to their
 * UTF-8 encoded codepoints. Use with fontawesome-webfont.ttf and ImGui
 * to render icon glyphs inline with text.
 *
 * @see https://github.com/FortAwesome/Font-Awesome/tree/4.x
 */
